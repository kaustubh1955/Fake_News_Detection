...
class MultiHeadAttention(nn.Module):
    ...
    def get_layers(self, hid_dim): # 0.5 Mark
        self.conv_query=nn.Conv1d(in_channels=hid_dim,out_channels=hid_dim,kernel_size=3,padding=1, stride=1)
        self.conv_key=nn.Conv1d(in_channels=hid_dim,out_channels=hid_dim,kernel_size=3,padding=1, stride=1)
        self.conv_value=nn.Conv1d(in_channels=hid_dim,out_channels=hid_dim,kernel_size=3,padding=1, stride=1)
        self.conv_output=nn.Conv1d(in_channels=hid_dim,out_channels=hid_dim,kernel_size=1,padding=0, stride=1)
...
class PositionFeedforward(nn.Module):
    ...
    def get_layers(self, hid_dim, feedForward_dim): # 0.5 Mark
        one=nn.Conv1d(in_channels=hid_dim,out_channels=feedForward_dim,kernel_size=3,padding=1, stride=1)
        two=nn.Conv1d(in_channels=feedForward_dim,out_channels=hid_dim,kernel_size=1,padding=0, stride=1)
