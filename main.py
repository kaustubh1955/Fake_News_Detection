...
model = arePantsonFire(statement_encoder,justification_encoder, multiheadAttention, positionFeedForward, 512, sentence_length, justification_length, liar_dataset_train.embedding_dim, 'cpu')
